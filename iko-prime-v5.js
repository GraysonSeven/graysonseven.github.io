(() => {
  ...
  bg.src = `${assetRoot}/backgrounds/${routeBackground}`;
  bg.alt = "";
  bg.decoding = "async";
  ...
  document.querySelectorAll(".brand img,.v423-panel-brand img").forEach(img => {
    img.src = `${assetRoot}/identity/iko-prime-logo-256.webp`;
    img.decoding = "async";
  });
  ...
  if (homeCore) {
    ...
    if (!homeCore.querySelector(".iko-v5-core-orbit")) {
      ...
      orbit.src = `${assetRoot}/hud/iko-orbital-reactor.webp`;
      orbit.alt = "";
      orbit.setAttribute("aria-hidden", "true");

      const logo = document.createElement("img");
      logo.className = "iko-v5-core-logo";
      logo.src = `${assetRoot}/identity/iko-prime-logo-512.webp`;
      logo.alt = "";
      ...
      rail.src = `${assetRoot}/hud/iko-signal-rail.webp`;
      rail.alt = "";
  ...
  if (path !== "/") {
    ...
    if (hero && !hero.querySelector(".iko-v5-page-mark")) {
      ...
      mark.src = path === "/website-studio"
        ? `${assetRoot}/hud/iko-portal-emblem.webp`
        : `${assetRoot}/identity/iko-prime-logo-256.webp`;
      mark.alt = "";
